/**
 * Atlas UI — Security Tab Component (High Fidelity)
 * 
 * Monitors for PII leaks and CORS violations.
 */
...
(function () {
    ...
    const renderSecurity = () => {
        ...
        const secEvents = violations.filter(v => v.source.includes('Security') || v.source.includes('Warden'));
...
export const SECURITY_MONITOR = buildSecurityScript();
