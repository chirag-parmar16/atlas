/**
 * Atlas UI — Event Recorder Tool
 * 
 * Provides session recording controls and interaction tracking.
 * UPDATED: Replaced emojis with SVG icons and improved layout.
 */

export function buildExtrasScript(): string {
    return `
(function () {
    ...
    const renderRecorder = () => {
        ...
        btn.onclick = () => {
             if (window.atlasStartRecording) window.atlasStartRecording();
...
export const EXTRAS = buildExtrasScript();
