/**
 * Atlas UI — Storage Tab Component (High Fidelity)
 * 
 * Visualizes storage usage and lists heavy resources.
 */

export function buildStorageScript(): string {
    return `
(function () {
...
export const STORAGE = buildStorageScript();
