/**
 * Atlas UI — Application Tab Component (High Fidelity)
 * 
 * Lists meta tags, scripts, stylesheets, and general page metrics.
 * UPDATED: Replaced emojis with SVG icons.
 */

export function buildApplicationScript(): string {
    return `
(function () {
...
export const APPLICATION = buildApplicationScript();
